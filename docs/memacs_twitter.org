...
#+begin_src python :shebang #!/usr/bin/env python3 :tangle ./twitter_get_auth.py :exports none :noweb yes
...
#+begin_src python :shebang #!/usr/bin/env python3 :tangle ./twitter_get_final_tokens.py :exports none :noweb yes
from twython import Twython
APP_KEY = 'Your Consumer Key'
APP_SECRET = 'Your Consumer Secret'
