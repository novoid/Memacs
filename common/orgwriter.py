...
class OrgOutputWriter(object):
    ...
    def __init__(self,short_description, tag, file_name=None,test=False,append=False):
        """
        @param file_name:  
        """
        self.__test = test
    ...
    def __write_header(self):
        ...
        self.write_commentln("To add this file to your org-agenda files open the stub file (file.org) not this file(file.org_archive) with emacs and: M-x org-agenda-file-to-front")
        self.write_org_item(self.__short_description + "        :Memacs:"+self.__tag+":")
