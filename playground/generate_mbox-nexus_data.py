...
MESSAGEID_REGEX = re.compile("Message-ID: (.*)")
...
USAGE = "\n\
         "+sys.argv[0]+"\n\
\n\
This script parses mbox files and generates an Org-mode file whose\n\
entry lines show the emails in Org-mode agenda.\n\
\n\
...
def parse_mbox(filename, outputfile):
    ...
    for line in open(filename, 'r'):
        ...
        if not is_header and was_empty_line and fromlinecomponents:
            ...
            last_subject = subjectcomponents.group(1)
