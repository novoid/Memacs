## Time-stamp: <2011-08-06 14:25:21 vk>
#+TODO: WISH(w!) PLANNING(p!) DEVELOPMENT(d!) EXPERIMENTAL(e!) | USABLE(u!) STABLE(s!) CANCELED(c@)
...
(states: TODO, WAITING, SOMEDAY) Nexuses which extract data from all
...
** PLANNING Filedatestamp-locate-Nexus
:LOGBOOK:
- State "PLANNING"   from ""           [2011-08-06 Sat 14:23]
:END:
:PROPERTIES:
:CREATED: <2011-08-06 Sat 14:23>
:END:
...
** DEVELOPMENT Maildir-Nexus
:LOGBOOK:
- State "DEVELOPMENT" from ""           [2011-08-06 Sat 14:25]
:END:
:PROPERTIES:
:CREATED: <2011-08-06 Sat 14:25>
:END:
...
** WISH Serendipity-Nexus
:LOGBOOK:
- State "WISH"       from ""           [2011-08-06 Sat 14:25]
:END:
:PROPERTIES:
:CREATED: <2011-08-06 Sat 14:25>
:END:
